[
  ...
  },
  {
    ...
    chains: [
      1, 137, 42161, 56, 324, 59144, 5000, 8453, 534352, 169, 255, 7000, 167000,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [
      1, 56, 61, 42161, 324, 59144, 5000, 8453, 534352, 169, 81457, 8217,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [
      1, 56, 128, 137, 250, 1666600000, 42161, 10, 34443, 196, 7560, 167000,
      1625,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [
      1, 324, 42161, 137, 56, 58, 10, 34443, 196, 7560, 60808, 1116, 1625,
      167000,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [1, 137, 42161, 324, 196, 60808, 34443, 2222, 1625],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [
      1, 56, 42161, 324, 59144, 8453, 10, 810180, 34443, 7560, 60808, 167000,
      2222,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    chains: [
      1, 137, 42161, 324, 59144, 8453, 10, 810180, 34443, 196, 7560, 60808,
      167000, 1625,
    ],
    contracts: {
      1: {
  ...
  },
  {
    ...
    metadata: {
      blockExplorerUrls: [
        "https://bscscan.com/token/0xd9de2b1973e57dc9dba90c35d6cd940ae4a3cbe1",
      ],
      rpcUrls: ["https://mainnet-rpc.dogcoin.me"],
    },
  },
  ...
  },
  {
    name: "Boom!",
    symbol: "BOOM",
    icon: "https://izumi-finance.oss-ap-southeast-1.aliyuncs.com/tokens/boom.png",
    chains: [81457],
    contracts: {
      81457: {
  ...
  },
  {
    name: "Bang!",
    symbol: "BANG",
    icon: "https://izumi-finance.oss-ap-southeast-1.aliyuncs.com/tokens/bang.png",
    chains: [81457],
    contracts: {
      81457: {
  ...
  },
  {
    name: "Frog Rich",
    symbol: "RICH",
    icon: "https://izumi-finance.oss-ap-southeast-1.aliyuncs.com/tokens/rich.png",
    chains: [81457],
    contracts: {
      81457: {
